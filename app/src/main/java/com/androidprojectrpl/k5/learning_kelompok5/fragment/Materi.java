...
public class Materi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list.addAll(DataPost.getListDataMateri());
        ...
        rvMateri.addItemDecoration(new DividerItemDecoration(getActivity(),
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ItemClickSupport.addTo(rvMateri).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            @Override
